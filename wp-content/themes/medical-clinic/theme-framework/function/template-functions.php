		...
		if (sizeof($images) > 0 && $images[0] != '') {
			...
			foreach ($images as $image) {				
				...
				echo '<div class="' . $img_columns . '">';
					...
					medical_clinic_thumb_rollover($cmsmasters_id, $thumb_size, true, false, 'img_' . get_the_ID(), $image);
			...
			medical_clinic_thumb(get_the_ID(), $size_full, false, 'img_' . get_the_ID(), true, true, false, true, false);
		}
	}
}
