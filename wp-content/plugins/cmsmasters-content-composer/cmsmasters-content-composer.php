...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '2.0.2');
		...
		define('CMSMASTERS_CONTENT_COMPOSER_TEMPLATE_DIR', 'theme-framework/cmsmasters-c-c/shortcodes');
	...
	function cmsmasters_composer_enqueue_scripts($hook) {
		...
		/* Start Global Translations */
			...
			'border_radius_descr_note_3' =>						__('border radius generator', 'cmsmasters-content-composer'),
			'border_radius_descr_note_4' =>						__('But copy only value of the first rule, for example like', 'cmsmasters-content-composer'),
		...
		/* Start cmsmasters_simple_icon and cmsmasters_icon_box Translations */
			...
			'icon_box_choice_pos_box_top' =>					__('Centered box with icon at the top of', 'cmsmasters-content-composer'),
			'icon_box_choice_pos_heading_left' =>				__('Box with icon before title', 'cmsmasters-content-composer'),
			'icon_box_choice_pos_box_left' =>					__('Box with icon at the left of', 'cmsmasters-content-composer'),
			'icon_box_choice_pos_box_left_top' =>				__('Box with icon at the left top of', 'cmsmasters-content-composer'),
