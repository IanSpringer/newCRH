...
if (isset($_POST['offset'])) {
	...
	if ($cmsmasters_query->have_posts()) : 
		while ($cmsmasters_query->have_posts()) : $cmsmasters_query->the_post();
			if ($layout == 'puzzle') {
				echo cmsmasters_composer_ob_load_template('theme-framework/postType/portfolio/project-puzzle.php', $metadata_arr);
			} else {
				echo cmsmasters_composer_ob_load_template('theme-framework/postType/portfolio/project-grid.php', $metadata_arr);
			}
		endwhile;
	endif;
