		...
		while ($cmsmasters_query->have_posts()) : $cmsmasters_query->the_post();
			if ($layout == 'columns') {
				if ($layout_mode == 'puzzle') {
					echo cmsmasters_composer_ob_load_template('theme-framework/postType/blog/post-puzzle.php', $metadata_arr);
				} else {
					echo cmsmasters_composer_ob_load_template('theme-framework/postType/blog/post-masonry.php', $metadata_arr);
				}
			} elseif ($layout == 'timeline') {
				echo cmsmasters_composer_ob_load_template('theme-framework/postType/blog/post-timeline.php', $metadata_arr);
			} else {
				echo cmsmasters_composer_ob_load_template('theme-framework/postType/blog/post-default.php', $metadata_arr);
			}
		endwhile;
	endif;
